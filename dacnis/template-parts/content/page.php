<div id="post-<?php the_ID(); ?>" class=" <?php get_post_class(); ?> wp-block wp-block-kubio-section  position-relative wp-block-kubio-section__outer dacnis-page__k__p7Z7tbZgOg-outer dacnis-local-474-outer d-flex h-section-global-spacing align-items-lg-center align-items-md-center align-items-center" data-kubio="kubio/section">
