<div class="wp-block wp-block-kubio-query-layout  position-relative wp-block-kubio-query-layout__outer dacnis-index__k__1MCYzfcZN-outer dacnis-local-369-outer d-flex h-section-global-spacing align-items-lg-center align-items-md-center align-items-center" data-kubio="kubio/query-layout" id="blog-layout">
	<div class="position-relative wp-block-kubio-query-layout__inner dacnis-index__k__1MCYzfcZN-inner dacnis-local-369-inner h-section-grid-container h-section-boxed-container">
		<div class="wp-block wp-block-kubio-row  position-relative wp-block-kubio-row__container dacnis-index__k__baLWB4dRKjp-container dacnis-local-370-container gutters-row-lg-0 gutters-row-v-lg-0 gutters-row-md-0 gutters-row-v-md-3 gutters-row-3 gutters-row-v-0" data-kubio="kubio/row">
			<div class="position-relative wp-block-kubio-row__inner dacnis-index__k__baLWB4dRKjp-inner dacnis-local-370-inner h-row align-items-lg-stretch align-items-md-stretch align-items-stretch justify-content-lg-center justify-content-md-center justify-content-center gutters-col-lg-0 gutters-col-v-lg-0 gutters-col-md-0 gutters-col-v-md-3 gutters-col-3 gutters-col-v-0">
				<div class="wp-block wp-block-kubio-column  position-relative wp-block-kubio-column__container dacnis-index__k__kxeqsSpdy-n-container dacnis-local-371-container d-flex h-col-lg h-col-md-auto h-col-auto" data-kubio="kubio/column">
					<div class="position-relative wp-block-kubio-column__inner dacnis-index__k__kxeqsSpdy-n-inner dacnis-local-371-inner d-flex h-flex-basis h-px-lg-2 v-inner-lg-0 h-px-md-1 v-inner-md-0 h-px-2 v-inner-0">
						<div class="position-relative wp-block-kubio-column__align dacnis-index__k__kxeqsSpdy-n-align dacnis-local-371-align h-y-container h-column__content h-column__v-align flex-basis-100 align-self-lg-start align-self-md-start align-self-start">
							<div class="wp-block wp-block-kubio-query  position-relative wp-block-kubio-query__container dacnis-index__k__CtKC_EuIZL-container dacnis-local-372-container" data-kubio="kubio/query">
								...
								<div class="wp-block wp-block-kubio-query-pagination  position-relative wp-block-kubio-query-pagination__container dacnis-index__k__vD7AVCTELY-container dacnis-local-384-container gutters-row-lg-2 gutters-row-v-lg-2 gutters-row-md-2 gutters-row-v-md-2 gutters-row-0 gutters-row-v-2" data-kubio="kubio/query-pagination">
									<div class="position-relative wp-block-kubio-query-pagination__inner dacnis-index__k__vD7AVCTELY-inner dacnis-local-384-inner h-row align-items-lg-stretch align-items-md-stretch align-items-stretch justify-content-lg-center justify-content-md-center justify-content-center gutters-col-lg-2 gutters-col-v-lg-2 gutters-col-md-2 gutters-col-v-md-2 gutters-col-0 gutters-col-v-2">
										...
										<div class="wp-block wp-block-kubio-column  position-relative wp-block-kubio-column__container dacnis-index__k__P2OarhUKUK-container dacnis-local-387-container d-flex h-col-lg h-col-md h-col" data-kubio="kubio/column">
											<div class="position-relative wp-block-kubio-column__inner dacnis-index__k__P2OarhUKUK-inner dacnis-local-387-inner d-flex h-flex-basis h-px-lg-2 v-inner-lg-2 h-px-md-2 v-inner-md-2 h-px-1 v-inner-2">
												<div class="position-relative wp-block-kubio-column__align dacnis-index__k__P2OarhUKUK-align dacnis-local-387-align h-y-container h-column__content h-column__v-align flex-basis-100 align-self-lg-center align-self-md-center align-self-center">
													<div class="wp-block wp-block-kubio-pagination-numbers  position-relative wp-block-kubio-pagination-numbers__outer dacnis-index__k__tRiQFlrj8q-outer dacnis-local-388-outer" data-kubio="kubio/pagination-numbers">
